const Sec1Event = () => {
    return (  
        <div className="pt-[70px] px-[20px]">
            ...
            <div className="px-[10px] flex flex-col w-full mt-[20px]">
                <div className="flex flex-row justify-between items-center w-full">
                    <div className="bg-[#d7fec8] w-[70%] flex flex-row items-center justify-between p-[10px] md:p-[20px]">
                        <p><span className="font-bold">Repair Day,</span><br />for all students</p>
                        <p>LTB, CBAS</p>
                    </div>
                    <div className="bg-[#d7fec8] w-[20%] text-center p-[10px] md:p-[20px]">
