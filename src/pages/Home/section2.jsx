            ...
            <div className='flex flex-row justify-between items-center w-full'>
                <div className='w-[50%]'>
                    <div className='flex flex-row items-center gap-[10px]'>
                        <div className='h-[50px] w-[50px] bg-[#d7fec8] rounded-full shadow-xl flex justify-center items-center'><FaRegQuestionCircle className='text-[#1b6535] w-[25px] h-[25px]'/></div>
                        <div>
