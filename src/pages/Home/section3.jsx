    ...
    return (  
        <div className="px-[50px] mt-[100px]">
            ...
            <div className="flex flex-row w-full h-[500px] gap-x-[10px] mt-[50px]">
                <div className={`${tab === 0 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500`} onClick={()=> setTab(0)}>
                    <img src={ one } className="object-cover w-full h-full"/>
                </div>
                <div className={`${tab === 1 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500`} onClick={()=> setTab(1)}>
                    <img src={ two } className="object-cover w-full h-full"/>
                </div>
                <div className={`${tab === 2 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500`} onClick={()=> setTab(2)}>
                    <img src={ three } className="object-cover w-full h-full"/>
                </div>
                <div className={`${tab === 3 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500`} onClick={()=> setTab(3)}>
