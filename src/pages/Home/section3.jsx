        ...
        <div className="px-[50px] mt-[100px]">
            ...
            <div className="flex flex-row w-full h-[500px] gap-x-[10px] mt-[50px]">
                <div className={`${tab === 0 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500 relative`} onClick={()=> setTab(0)}>
                    ...
                    <div className={`${tab === 0 ? "text-black" : "text-white text-center"} absolute bottom-[20px] left-[20px] transition-all duration-500`}>
                ...
                <div className={`${tab === 1 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500 relative`} onClick={()=> setTab(1)}>
                    ...
                    <div className={`${tab === 1 ? "text-black" : "text-white text-center"} absolute bottom-[20px] left-[20px] transition-all duration-500`}>
                ...
                <div className={`${tab === 2 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500 relative`} onClick={()=> setTab(2)}>
                    ...
                    <div className={`${tab === 2 ? "text-black" : "text-white text-center"} absolute bottom-[20px] left-[20px] transition-all duration-500`}>
                ...
                <div className={`${tab === 3 ? "w-[60%]" : "w-[30%]"}  transition-all duration-500 relative`} onClick={()=> setTab(3)}>
                    ...
                    <div className={`${tab === 3 ? "text-black" : "text-white text-center"} absolute bottom-[20px] left-[20px] transition-all duration-500`}>
