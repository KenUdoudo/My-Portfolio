        ...
        <div className="px-[50px] mt-[100px]">
            <div className="flex flex-row justify-start items-start w-full">
                <div className='flex flex-row items-center gap-[10px]'>
                    <div className='h-[50px] w-[50px] bg-[#d7fec8] rounded-full shadow-xl'><HiOutlineSignal className='text-[#1b6535]'/></div>
                    <div>
            ...
            <div className="w-full bg-black pt-[30px] pb-[20px] pl-[40px] pr-[30px] mt-[30px]">
                <div className='w-full flex flex-row justify-between items-center pr-[50px]'>
                ...
                <div className="flex flex-col justify-start items-start w-full my-[70px]">
                            <p className='text-[45px] text-white font-bold'>Ctrl + Alt + Compete</p>
                            <p className='text-[30px] text-white font-light'>Show workings, guy!</p>    
                </div>
